...
// const num = prompt("Введіть довільне ціле число від 1 до 4 включно");
// let result = "";
// switch (Number(num)) {
//     case 1: result = "зима";
//         break;
...
// const minuts = Number(prompt("Введіть кількість хвилин прогулянки!?"));
// let recountMinuts;
// let recountHours;
// if (minuts / 60 < 0) {
//     recountHours = 0;
//     recountMinuts = minuts;
// } else if (minuts / 60 === 1) {
//     recountHours = 1;
//     recountMinuts = 0;
// } else {
//     recountHours = Math.floor(minuts / 60);
//     recountMinuts = minuts - recountHours * 60;
// }

// alert(`${String(recountHours).padStart(2, 0)}:${String(recountMinuts).padStart(2, 0)}`)
