...
// ];
// //-------------------------------------------------------------
// let someAge = people.find(item => item.age < 20);
// if (someAge){
//   console.log(true);
// }
// const someAge = people.some(item => item.age < 20);
// console.log(someAge);
...
// //-------------------------------------------------------------
// let num = numbers.every(item => {return item % 2 === 0});
// console.log(num);
...
// //-------------------------------------------------------------
// const sorted = user.filter(user => user.age > 20).map(user => user.name);
// console.log(sorted);
...
//   }
//   number {
//     onst first = Number(prompt('Enter first number'));
